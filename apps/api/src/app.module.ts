 ...
 */
@Module({
  controllers: [AuthController, UsersController, RolesController, SettingsController, HerdController, BreedingController, InventoryController, HealthController, FarmOpsController, SearchController],
  providers: [
    PrismaService,
    AuditService,
    AuthService,
